...
# Get active user and use it to set ZSH path
echo id -un > $USER
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status nvm ip)
...
alias zshsrc="source ~/.zshrc; clear"
...
alias git_q="git pull"
alias git_k="git checkout"
alias git_kb="git checkout -b"
alias git_km="git checkout --"
